    ...
    <div className='md:h-screen bg-[aliceblue] pt-10'>
        <div className='px-4'>
            ...
            <div className='w-[100%] md:w-[60%]'>
                <h1 className='font-semibold md:text-5xl text-[#37517e] text-3xl text-center mb-10'>Who Are We?</h1>
        ...
        <div className='md:py-28 py-20 md:px-10 px-4'>
            ...
            <div className='w-[100%] md:w-[60%]'>
                <h1 className='font-semibold md:text-5xl text-3xl text-center text-[#37517e] mb-10'>Our Vision</h1>
